...
/**
 * This class is represents a row in the Accessories View (vwAccessories_Library) table. Even
...
@Entity
@Table(name = "vwAccessories_Library")
@Indexed
...
public class Accessory implements Serializable {
	private transient String recordType = "ACCESSORY";
